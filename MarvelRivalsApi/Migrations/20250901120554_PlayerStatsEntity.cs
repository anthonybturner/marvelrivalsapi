...
{
    public partial class PlayerStatsEntity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerIcon", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTimePlayed = table.Column<string>(type: "text", nullable: true),
                    TotalTimePlayedRaw = table.Column<float>(type: "real", nullable: false),
                    TotalMvp = table.Column<int>(type: "integer", nullable: false),
                    TotalSvp = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerRanked", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerStatsPlayerInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ClubTeamId = table.Column<string>(type: "text", nullable: true),
                    ClubTeamMiniName = table.Column<string>(type: "text", nullable: true),
                    ClubTeamType = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerUnranked", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    InfoUpdateTime = table.Column<string>(type: "text", nullable: true),
                    LastHistoryUpdate = table.Column<string>(type: "text", nullable: true),
                    LastInsertedMatch = table.Column<string>(type: "text", nullable: true),
                    LastUpdateRequest = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerUpdates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: true),
                    PlayerIconId = table.Column<int>(type: "integer", nullable: false),
                    PlayerRankId = table.Column<int>(type: "integer", nullable: false),
                    PlayerTeamId = table.Column<int>(type: "integer", nullable: false),
                    PlayerStatsPlayerInfoId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Player", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Player_PlayerIcon_PlayerIconId",
                        column: x => x.PlayerIconId,
                        principalTable: "PlayerIcon",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Player_PlayerRank_PlayerRankId",
                        column: x => x.PlayerRankId,
                        principalTable: "PlayerRank",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Player_PlayerStatsPlayerInfo_PlayerStatsPlayerInfoId",
                        column: x => x.PlayerStatsPlayerInfoId,
                        principalTable: "PlayerStatsPlayerInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Player_PlayerTeam_PlayerTeamId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalMatches = table.Column<int>(type: "integer", nullable: false),
                    TotalWins = table.Column<int>(type: "integer", nullable: false),
                    PlayerUnrankedId = table.Column<int>(type: "integer", nullable: false),
                    PlayerRankedId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerOverallStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerOverallStats_PlayerRanked_PlayerRankedId",
                        column: x => x.PlayerRankedId,
                        principalTable: "PlayerRanked",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerOverallStats_PlayerUnranked_PlayerUnrankedId",
                        column: x => x.PlayerUnrankedId,
                        principalTable: "PlayerUnranked",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Uid = table.Column<long>(type: "bigint", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: true),
                    PlayerUpdatesId = table.Column<int>(type: "integer", nullable: false),
                    PlayerId = table.Column<int>(type: "integer", nullable: false),
                    OverallStatsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerStats_PlayerOverallStats_OverallStatsId",
                        column: x => x.OverallStatsId,
                        principalTable: "PlayerOverallStats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerStats_PlayerUpdates_PlayerUpdatesId",
                        column: x => x.PlayerUpdatesId,
                        principalTable: "PlayerUpdates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    MatchUid = table.Column<string>(type: "text", nullable: true),
                    MatchMapId = table.Column<int>(type: "integer", nullable: false),
                    MatchMapName = table.Column<string>(type: "text", nullable: true),
                    MapThumbnail = table.Column<string>(type: "text", nullable: true),
                    MatchPlayDuration = table.Column<double>(type: "double precision", nullable: false),
                    MatchSeason = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Player_PlayerIconId",
                table: "Player",
                column: "PlayerIconId");

            migrationBuilder.CreateIndex(
                name: "IX_Player_PlayerRankId",
                table: "Player",
                column: "PlayerRankId");

            migrationBuilder.CreateIndex(
                name: "IX_Player_PlayerStatsPlayerInfoId",
                table: "Player",
                column: "PlayerStatsPlayerInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_Player_PlayerTeamId",
                table: "Player",
                column: "PlayerTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerOverallStats_PlayerRankedId",
                table: "PlayerOverallStats",
                column: "PlayerRankedId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerOverallStats_PlayerUnrankedId",
                table: "PlayerOverallStats",
                column: "PlayerUnrankedId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerStats_OverallStatsId",
                table: "PlayerStats",
                column: "OverallStatsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerStats_PlayerUpdatesId",
                table: "PlayerStats",
                column: "PlayerUpdatesId");
